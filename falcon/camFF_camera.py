...
payload = '<?xml version="1.0" encoding="utf-8"?><envelope><header><security>usernametoken</security><username>admin</username><nc>OVwdDExWzcV2BDkqZCCnQYbqgJTuARQH</nc></header><body><command>get.system.login</command><content></content></body></envelope>'
